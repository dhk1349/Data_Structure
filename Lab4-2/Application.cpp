...
int Application::GetCommand()
{
	...
	cout << "\t   9 : 하부 목록 보기" << endl;
	cout << "\t  10 : 폴더 이진 검색" << endl;
	cout << "\t  11 : 텍스트 파일 만들기" << endl;
	cout << "\t  12 : 텍스트 파일 열기" << endl;
	cout << "\t  13 : 폴더 이름 바꾸기" << endl;
	cout << "\t  14 : 파일 이름 바꾸기" << endl;
	cout << "\t  15 : 파일 삭제하기" << endl;
	cout << "\t   0 : 종료" << endl; 
